...
class Rogue(Player):
    def __init__(self, name="Rogue"):
        super().__init__(name=name, hp=80, attack=15, defense=3)
        self.crit_rate = 0.2
        self.dodge = 0.15
...
class Warrior(Player):
    def __init__(self, name="Warrior"):
        super().__init__(name=name, hp=120, attack=12, defense=8)
        self.strength = 5
        self.rage = 0
...
class Knight(Player):
    def __init__(self, name="Knight"):
        super().__init__(name=name, hp=150, attack=10, defense=12)
